...
func TestCommandUsageHasGroups(t *testing.T) {
	...
	for _, group := range []string{
		"Run & interact", "Inspect & validate", "Workflows", "Observe runs",
...
func TestCommandUsageCoversCommands(t *testing.T) {
	...
	for _, cmd := range []string{
		...
		"prism policy", "prism workflow", "prism watch", "prism runs", "prism cost", "prism trace", "prism dashboard", "prism status",
