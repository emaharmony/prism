...
func TestRegisterBuiltins(t *testing.T) {
	...
	names := reg.List()
	expectedTools := []string{"echo", "list_dir", "read_file", "write_file_dry_run", "read_project", "search_files", "project_overview", "git_status", "git_log", "git_diff", "git_branch_list"}
